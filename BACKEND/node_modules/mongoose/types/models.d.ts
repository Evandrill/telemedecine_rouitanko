declare module 'mongoose' {
   ...
   * Models are responsible for creating and reading documents from the underlying MongoDB config
   */
  export interface Model<
    ...
    /**
     * Returns a document with its `_id` if at least one document exists in the config that matches
