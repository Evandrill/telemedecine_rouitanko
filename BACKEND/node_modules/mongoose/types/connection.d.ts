declare module 'mongoose' {
  ...
  interface ConnectOptions extends mongodb.MongoClientOptions {
    ...
    /** The name of the config you want to use. If not provided, Mongoose uses the config name from connection string. */
    dbName?: string;
  ...
  class Connection extends events.EventEmitter implements SessionStarter {
    ...
    /** Switches to a different config using the same connection pool. */
    useDb(name: string, options?: { useCache?: boolean, noListener?: boolean }): Connection;

    /** The username specified in the URI */
    readonly user: string;

    /** Watches the entire underlying config for changes. Similar to [`Model.watch()`](/docs/api/model.html#model_Model-watch). */
