declare module 'mongoose' {
  ...
  > {
    ...
    /**
     * By default, documents are automatically validated before they are saved to the config. This is to
    ...
    /**
     * By default, validation will run on modified and required paths before saving to the config.
