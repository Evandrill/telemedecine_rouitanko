...
const methods = {
   ...
   *
   * The first pull call will result in a atomic operation on the config, if pull is called repeatedly without saving the document, a $set operation is used on the complete array instead, overwriting possible changes that happened on the config in the meantime.
   *
   * @param {...any} [args]
