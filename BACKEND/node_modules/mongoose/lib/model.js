...
/**
 * Saves this document by inserting a new document into the config if [document.isNew](https://mongoosejs.com/docs/api/document.html#Document.prototype.isNew) is `true`,
 ...
 * @throws {DocumentNotFoundError} if this [save updates an existing document](https://mongoosejs.com/docs/api/document.html#Document.prototype.isNew) but the document doesn't exist in the config. For example, you will get this error if the document is [deleted between when you retrieved the document and when you saved it](documents.html#updating).
 * @return {Promise}
 * @api public
...
/**
 * Returns a document with `_id` only if at least one document exists in the config that matches
 ...
 *     });
 *
 * _NOTE: It is not recommended that you run this in production. Index creation may impact config performance depending on your load. Use with caution._
 *
...
/**
 * Counts number of documents matching `filter` in a config collection.
 *
 * #### Example:
 *
...
/**
 * Shortcut for saving one or more documents to the config.
...
/**
 * Takes an array of documents, gets the changes and inserts/updates documents in the config
