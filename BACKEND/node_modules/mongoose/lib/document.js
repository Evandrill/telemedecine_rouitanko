 ...
 *
 * On the other hand, if you load an existing document from the config
 ...
 * or sends an [updateOne](https://mongoosejs.com/docs/api/document.html#Document.prototype.updateOne()) operation **only** with the modifications to the config, it does not replace the whole document in the latter case.
 *
 * #### Example:
 *
 ...
 *
 * _During save, no custom options are applied to the document before being sent to the config._
 *
 * @param {Object} [options]
