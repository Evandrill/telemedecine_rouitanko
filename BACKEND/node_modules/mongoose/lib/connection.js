...
/**
 * The name of the config this connection points to.
 *
 * #### Example:
 *
...
/**
 * Helper for `dropDatabase()`. Deletes the given config, including all
 * collections, documents, and indexes.
 *
 * #### Example:
 *
 *     const conn = mongoose.createConnection('mongodb://127.0.0.1:27017/mydb');
 *     // Deletes the entire 'mydb' config
...
/**
 * Watches the entire underlying config for changes. Similar to
...
/**
 * Switches to a different config using the same [connection pool](https://mongoosejs.com/docs/api/connectionshtml#connection_pools).
 *
...
/**
 * Removes the config connection with the given name created with with `useDb()`.
 *
 * Throws an error if the config connection was not found.
 *
 * #### Example:
 *
 *     // Connect to `initialdb` first
